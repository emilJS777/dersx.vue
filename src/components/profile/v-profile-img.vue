<template>
  ...
  <div class="info d-grid g-gap-1" v-if="user">
    ...
    <p class="d-flex g-gap-1 a-items-center">
      ...
      <span class="d-grid">
        <span v-if="user.gender && lang.lang === 'arm'">{{user.gender.title_arm}}</span>
          <span v-if="user.gender && lang.lang === 'eng'">{{user.gender.title_eng}}</span>
          <span v-if="user.gender && lang.lang === 'rus'">{{user.gender.title_rus}}</span>
      </span>
    </p>
