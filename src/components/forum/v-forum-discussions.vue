<template>
  <div v-if="this.forum.title">
    <div class="bg-fff padding-1 d-grid">
      ...
      <span class="f-size-small"><b>тема: </b><i>{{ this.forum.topic }}</i></span>
...
<!--       FORUM EDIT -->
    ...
    <div class="m-top-05 padding-1 bg-fff d-grid g-gap-_3 forum_discussion" v-for="forum_discussion in forum_discussions" :key="forum_discussion.id">
      ...
      <span>{{ forum_discussion.description }}</span>
