...
export default {
    ...
    mounted() {
       ...
       this.$store.dispatch("dynamic_link/GET", {query: `publication?id=${this.publication_id}`, title: `skillx web platform`, description: `${this.description}`, image: this.image}).then(data => {
           this.shortLink = data
